...
export default function LoginPage() {
    ...
    return (
        <AuthLayout>
            ...
            <div className="mt-5 flex items-center justify-between text-xs sm:text-sm text-white/80 px-1 font-medium">
            ...
            <div className="mt-8 mb-5 relative">
                ...
                <div className="relative flex justify-center text-[10px] font-bold uppercase tracking-widest">
                    <span className="px-3 bg-transparent text-white/70 drop-shadow-sm backdrop-blur-sm">OR LOGIN WITH</span>
                </div>
            </div>
