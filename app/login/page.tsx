            ...
            <div className="w-full max-w-md relative z-10 transition-all duration-500 ease-out transform hover:scale-[1.01]">
                ...
                <div className="bg-white/10 backdrop-blur-xl p-8 sm:p-10 border border-white/20 rounded-3xl shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="text-center mb-8 relative z-10">
                        <h1 className="text-3xl font-bold tracking-wide text-white drop-shadow-md pb-2">Welcome</h1>
                    </div>
                    ...
                    <div className="mt-6 flex items-center justify-between text-sm text-white/80 relative z-10 px-1 font-medium">
                        <Link href="/forgot-password" tabIndex={-1} className="hover:text-white hover:drop-shadow-md hover:underline decoration-white/50 transition-all duration-200">
                            Forgot Password ?
                        </Link>
                        <Link href="/signup" className="hover:text-white hover:drop-shadow-md hover:underline decoration-white/50 transition-all duration-200">
                            Sign Up
                        </Link>
                    </div>
                    ...
                    <div className="mt-10 mb-6 relative z-10">
                        ...
                        <div className="relative flex justify-center text-[11px] font-bold uppercase tracking-widest">
                            <span className="px-4 bg-transparent text-white/70 drop-shadow-sm backdrop-blur-sm">OR LOGIN WITH</span>
                        </div>
                    </div>
